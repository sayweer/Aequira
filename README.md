...
```bash
pnpm install
pnpm test            # 225 tests: 26 contract, 37 sdk, 100 ui, 62 cli
```
...
pnpm test                   # 225 tests, no proof server needed
...
| Passing test suite                         | 225 tests, `pnpm test`; CI `verify` job                                          |
