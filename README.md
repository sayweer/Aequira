...
```bash
pnpm install
pnpm test            # 229 tests: 26 contract, 37 sdk, 103 ui, 62 cli
```
...
pnpm test                   # 229 tests, no proof server needed
...
| Passing test suite                         | 229 tests, `pnpm test`; CI `verify` job                                          |
