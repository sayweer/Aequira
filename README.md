...
```bash
pnpm install
pnpm test            # 221 tests: 26 contract, 37 sdk, 96 ui, 62 cli
```
...
pnpm test                   # 221 tests, no proof server needed
...
| Passing test suite                         | 221 tests, `pnpm test`; CI `verify` job                                          |
