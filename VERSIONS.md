...
passes 44 local `node:test` tests: 10 contract, 4 SDK, and 30 CLI/runtime tests.
...
round-trip through the Level provider. Backup format v2 authenticates its public
